...
model = BertForSequenceClassification.from_pretrained('/app/communications/polarization/bert_classifier/models/bert_beginning_end')
#config = BertConfig.from_json_file('../models/bert_classifier_2epoch_256size/config.json')
tokenizer = BertTokenizer.from_pretrained('/app/communications/polarization/bert_classifier/models/bert_beginning_end')
